...
Source0  : https://files.pythonhosted.org/packages/85/55/6d1741a1780e5e65038b74bce6689da15f620261c490c3511eb4c12bac4b/myst_parser-4.0.0.tar.gz
...
%prep
%setup -q -n myst_parser-4.0.0
cd %{_builddir}/myst_parser-4.0.0
pushd ..
cp -a myst_parser-4.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722885284
